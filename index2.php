...
<html>
  ...
  <body>
    ...
    <nav class="floating-menu-topleft">
      <button type="button" class="collapsible" onclick="changeIcon()"><h3>Hello,
      <?php 
      echo $_SESSION['user'];?>
      
      &nbsp;&nbsp;<span class="ti-arrow-circle-down" style="vertical-align: -1px" id="theIcon"></span></h3></button>
      <div class="content">
    ...
    <nav class="floating-menu-bottomLeft">
        ...
        <button type="button" onclick="window.open('jupyter.html')"><span class="ti-stats-up"></span></button>
        <br /><br />
